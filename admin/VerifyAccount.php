...
<head>
    ...
    <title>Verify Account Smart Bank</title>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content gray_bg">
                ...
                <div class="modal-body light">
                    ...
                    <!-- KYC Document -->
                    <h6 style="margin-bottom: 30px;margin-top: 30px;border-bottom: 1px solid;display: table;">National identity card details: </h6>




                    <!-- Trigger the Modal -->
                    <img id="AdharImg" class="kycImg" alt="Back side of NIC" style="width:100%;max-width:300px">
                    <img id="PanImg" class="kycImg" alt="Front side of NIC" style="width:100%;max-width:300px;margin-left: 20%;">
