...
127.0.0.1/Smartbank/customer_detail/		http://localhost/phpmyadmin/tbl_sql.php?db=Smartbank&table=customer_detail
...
<head>
    ...
    <title>Withdraw Smart Bank</title>
        ...
        <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
            <div class="simplebar-content" style="padding: 0px;">
                <a class="sidebar-brand" href="../../index.php">
                    <span class="align-middle">SMART BANK</span>
                </a>
                                        ...
                                        <div class="col-lg-12 px-2">
                                            <div class="submenu-box">
                                                <ul class="list-unstyled m-0">
                                                    <li><a class="active" href="../wallet/Withdraw.php">Withdraw Money</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                <div class="d-sm-flex align-items-center mb-4" style="justify-content:center;">
                                    <h1 class="h3 mb-0 light" style="text-align: center;">Withdraw Money</h1>
                                </div>
                                                ...
                                                <div style="margin-left: 15%; margin-right: 15%;">
                                                    <div class="input-group mt-5">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text gray_bg light" id="inputGroup-sizing-default"><i class='bx bx-left-arrow-alt' style='color:#ff2d30'></i></span>
                                                        </div>
                                                    ...
                                                    <div id="Deposit" class="d-grid gap-2 mt-5 col-10 mx-auto">
                                                        ...
                                                        <button type="button" style="margin-top: 5%; margin-bottom: 15%;" class="btn btn-danger btn-lg btn-block">Withdraw</button>
                    ...
                    <div class="container-fluid">
                        <div class="row text-muted">
                            <div class="col-6 text-left">
                                <p class="mb-0">
                                    <a href="../../index.php" class="text-muted light"><strong>Smart Bank
                                        </strong></a> &copy
                                </p>
                            </div>
