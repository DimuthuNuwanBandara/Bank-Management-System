...
$(document).ready(function () {
    ...
    $('#AdharNo').blur(function () {
        ...
        if (AdharNo == "" || AdharNo.length > 12 || AdharNo.length < 9 || AdharNo.length == 10 || AdharNo.length == 11) {
            $('#AdharError').text('Invalid NIC Number');
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response != "0") {
                        $("#AdharError").text("NIC Number Already Exist!");
                        $("#nextBtn").attr('disabled', true);
                        AdharError = 1;
                    }
                    else {
    ...
    $("#PanNo").blur(function () {
        let PanNo = $(this).val();
        let Expression4 = /^[a-zA-Z\s]+$/;
        if (PanNo == "") {
            $("#PanError").text("Please Enter your Address");
            $("#nextBtn").attr('disabled', true);
            PanError = 1;
        }
        else {
            ...
            if (!Expression.test(PanNo)) {
                $("#PanError").text("Name doesn't contain Numbers");
                $("#nextBtn").attr('disabled', true);
                PanError = 1;
            }
            else {
