...
if (isset($_POST['submit'])) {
    ...
    if ($Pan_Number != null) {
        ...
        if (preg_match_all('!\d+!', $Pan_Number == 1)) {
            $Pan_Number_error = "* Numeric value not allowed in Address";
    }
}
    ...
    if (!is_numeric($Adhar_Number) || is_null($Adhar_Number) || !preg_match('/^[0-9]{12}+$/', $Adhar_Number)) {
        $Adhar_Number_error = "Invalid NIC Number";
    } else {
        ...
        if (mysqli_num_rows($result1) > 0) {
            $Adhar_Number_error = "* NIC Number Already Exist";
        }
    }
    ...
    if (!empty($Pan_fileName) && !empty($Adhar_fileName)) {
        ...
        if ($Pan_fileSize <= 2000000 && $Adhar_fileSize <= 2000000) {
            ...
            if (in_array($Pan_file_extention, $Valid_Extention) && in_array($Adhar_file_extention, $Valid_Extention)) {
                ...
                $Pan_destinationFile = 'customer_data/Front_doc/' . $Pan_Unique_Name;


                // Adharcard Destination Variable
                $Adhar_destinationFile = 'customer_data/Back_doc/' . $Adhar_Unique_Name;
...
<head>
    ...
    <title>Create Account Smart Bank</title>
...
<body>
    ...
    <form id="regForm" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md">
                    <div class="col-md">
                        <div class="form-floating">
                            ...
                            <label for="floatingInputGrid">National identity card number (without 'v' letter)</label>
        ...
        <div class="tab mb-3" id="KycTab">
            ...
            <p class="SubAction">Verify your NIC details</p>

            <div class="form-group mb-3">
                <label for="exampleFormControlFile1">Front side of NIC</label>
            ...
            <div class="form-groupmb-3">
                <label for="exampleFormControlFile1">Back side of NIC</label>
