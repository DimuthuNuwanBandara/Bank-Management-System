                    ...
                    <div class="col-sm-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text mb-4 pl-2 pr-2">Smart Bank</p>
                                                    ...
                                                    <div class="card dcard-back">
                                                        <div class="card-body">
                                                            <div class="d-flex justify-content-between">
                                                                <h5 class="text-light">Smart Bank</h5>
                                                ...
                                                <div id="OnCardToggle" class="card dcard-back">
                                                    <div class="card-body" style="padding: 0px;">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="description">This card issued by Smart Bank Bank pursuant to a license from Visa Sri Lanka,
