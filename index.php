...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="index.php" class="logo"><img src="assets/img/Logo3.png" alt="" class="img-fluid"> &nbsp Smart Bank</a>
      <!-- <h1 class="logo"><a href="index.html">Smart Bank</a></h1> -->
      ...
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <div class="heroBtn">
            ...
            <div><a href="user/login.php" class="btn-get-started scrollto">&nbsp &nbsp &nbsp Login &nbsp &nbsp &nbsp</a></div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>4 Step Banking System</h3>
            <p class="font-italic">
              You just need to follow 4 steps to start banking with us. Lets introduce to you with account creation steps.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> Fill Your Basic Detail.</li>
              <li><i class="bi bi-check-circle"></i> Upload Your NIC Document.</li>
              <li><i class="bi bi-check-circle"></i> Validate Your Document and Mobile Number.</li>
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-green">
              ...
              <h4><a href="Securepayment.html">Secure Payment</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-blue ">
              ...
              <h4><a href="cards.html">Credit & Debit Cards</a></h4>
              <p>Manage your credit card and debit card activity with us, without any problems.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <h4><a href="onlineBanking.html">Online Banking</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-yellow">
              ...
              <h4><a href="insurance.html">Insurance</a></h4>
              <p>Secure your and your family’s future with our various insurance plans and services</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red">
              ...
              <h4><a href="service24x7.html">24 x 7 Service</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-teal">
              ...
              <h4><a href="loans.html">Loans</a></h4>
              <p>Loans approved with the digital documents and digital signature.</p>
            </div>
          </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  Smart Bank is the best bank for Monitoring account it provide data in graphical manner from that can we understand our account is in profit or loss. Also i use saving option which is wonderful.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/test-1.jpg" class="testimonial-img" alt="">
                <h3>Lakmal Erandima</h3>
                <h4>Customer</h4>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  The Transaction system of the Smart bank is very fast. We can easily manage our transaction history
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  and start your online banking. Thank You Smart Bank!
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/test-3.jpg" class="testimonial-img" alt="">
                <h3>Isuru Dayananda</h3>
                <h4>Customer</h4>
              </div>
            </div><!-- End testimonial item -->
        ...
        <div class="faq-list">
          <ul>
            <li data-aos="fade-up" data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">How to register to the website ? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
                  You just need to follow 4 steps to start banking with us. Lets introduce to you with account creation steps. <br>

                  1 Fill Your Basic Detail. <br>
                  2 Upload Your NIC Document. <br>
                  3 Validate Your Email Account. <br>
                  4 Create Username and Password. <br>
            ...
            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">What’s the document required for NIC? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
                <p>
                  You Just Need two Documents: <br>
                  1 Front side of NIC <br>
                  2 Back side of NIC
                </p>
              </div>
            </li>
            ...
            <li data-aos="fade-up" data-aos-delay="400">
              ...
              <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
                <p>
                  You Need to visit to bank for credit and debit card
                </p>
              </div>
            </li>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="info-box mb-4">
              <i class="bx bx-map"></i>
              <h3>Our Address</h3>
              <p>Smart Bank Colombo Rd, <br> Kurunegala, Sri Lanka</p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 ">
            <iframe class="mb-4 mb-lg-0" src="
              https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7911.85272848221!2d80.34789723488772!3d7.473384000000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae33a3a80d79d71%3A0x43e585aeb86a4e7!2sVehera%20Junction!5e0!3m2!1sen!2slk!4v1648367843432!5m2!1sen!2slk" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" frameborder="0" style="border:0; width: 100%; height: 384px;" allowfullscreen></iframe>
          </div>

          <div class="col-lg-6">
            <form action="../SmartBank/contact.php" method="POST">
              <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Kurunegala,<br>
              Sri Lanka <br><br>
              <strong>Phone:</strong> +94 77 523 6273<br>
              <strong>Email:</strong> smartbank2022@gmail.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="../SmartBank/#services">Services</a></li>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <h1 class="text-center mt-2">SMART BANK</h1>
          </div>
    ...
    <div class="container">
      ...
      <div class="copyright-wrap d-md-flex py-4">
        <div class="me-md-auto text-center text-md-start">
          <div class="copyright">
            &copy; Copyright <strong><span>Smart Bank</span></strong>. All Rights Reserved
          </div>
          <div class="credits">
            ...
            <!-- Designed by <a href="#">Smart Tech</a> -->
          </div>
        </div>
